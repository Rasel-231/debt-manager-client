      ...
      <motion.div {...MOTION_STAGGER} className="flex flex-col gap-6">
        <motion.div variants={MOTION_ITEM} className="text-center">
          ...
          <p className="text-sm text-slate-400 mt-1">
            Log in to manage your loans and payments.
          </p>
        </motion.div>
        ...
        {searchParams.get('next') && (
          <motion.p variants={MOTION_ITEM} className="text-center text-xs text-slate-500">
